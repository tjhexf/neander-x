...
uses
  ...
  Dialogs, StdCtrls, Menus, Buttons, uSimula, ExtCtrls, Process;
...
procedure TformPrincipal.e_valorKeyUp(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
...
begin
  ...
  // Diga ao AProcess qual o comando a ser executado
    AProcess.Executable:= 'xchm';
  // Passe o nome do arquivo de ajuda como parãmetro. Estamos executando "xchm neanderlin.chm":
    AProcess.Parameters.Add('./neanderlin.chm');

  // Fazemos AProcess executar o comando em  .Commandline:
    AProcess.Execute;
   {$ENDIF}
